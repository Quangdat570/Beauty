...
function addcart(cartImg, cartName, cartPrice) {
  ...
  var trContent =
    ` <tr><td class="body-plus"><img src="` +
    cartImg +
    `" alt="" ><span class="name-cart">` +
    cartName +
    `</span></td><td><span class="prices">` +
    cartPrice +
    `</span><span></span></td><td><input type="number" value="1" min="1" style="width: 40px;outline: none;"></td><td style="cursor: pointer;"><span class="delete-cart">Xóa</span></td></tr>`;
